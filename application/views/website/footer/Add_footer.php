...
box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75); padding: 20px 0px;">
                <form action="" method="POST" enctype="multipart/form-data" class="navbar-form" style="width: 100%; ">
                    <div class="form-group" style="width: 100%">
                        <div class="col-md-4">
                            <label for="" style="margin-top: 7px;" class="pull-right">Tên footer</label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group" style="width: 100%; margin-top: 20px;">
                        <div class="col-md-4">
                            <label for="" style="margin-top: 7px;" class="pull-right">Thông tin footer</label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group" style="width: 100%; margin-top: 20px;">
                        ...
                        <div class="col-md-8">
                            <?php if(isset($select_website) && !empty($select_website)){
                                foreach($select_website as $val){ ?>
                                    <div class="col-md-6">
                                        <label for=""><?=$val->name; ?> </label> <input type="checkbox" checked="checked" value="<?=$val->id; ?>" name="id_website[]" style="width: 20px; height: 20px;"/>
                                    </div>
                                <?php  }
                            } ?>
                        </div>
