...
box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75); padding: 20px 0px;">
                ...
                <div class="form-group" style="width: 100%">
                    <div class="col-md-4">
                        <label for="" style="margin-top: 7px;" class="pull-right">Tên danh mục hình ảnh</label>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="form-group" style="width: 100%; margin-top: 20px;">
                    <div class="col-md-4">
                        <label for="" style="margin-top: 7px;" class="pull-right">Thông tin danh mục hình ảnh</label>
                    </div>
                    <div class="col-md-8">
