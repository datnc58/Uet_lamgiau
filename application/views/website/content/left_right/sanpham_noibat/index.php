...
<!--            <a href="--><?//=base_url('website/Uet_content_leftright/AddSanPhamNoiBat');?><!--" class="btn btn-primary pull-left" style="border-radius: 0px;">Thêm sản phẩm nổi bật</a>-->
        </div>
        ...
        <table id="example1" class="table table-striped table-bordered" style="width:100%; margin-top: 20px !important;">
                    ...
                    <tbody>
                        <?php if(isset($sanpham_noibat)){ $i = 0; foreach ($sanpham_noibat as $spdm) {
