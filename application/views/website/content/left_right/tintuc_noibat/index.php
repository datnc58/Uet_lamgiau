...
<section class="content" style="text-align: center">
    ...
    <section class="content" style="text-align: center; background: #ffffff;">
        <div style="margin-bottom: 20px;">
            <a href="<?=base_url('website/Uet_content_leftright/AddTinTucNoiBat');?>" class="btn btn-primary pull-left" style="border-radius: 0px;">Thêm danh mục sản phẩm</a>
        </div>
        ...
        <table id="example1" class="table table-striped table-bordered" style="width:100%; margin-top: 20px !important;">
                    ...
                    <tbody>
                        <?php if(isset($tintuc_noibat)){ foreach ($tintuc_noibat as $spdm) {
                            $i = 0;
                            $i++; ?>
                                <tr>
                                     <td><?= $i; ?></td>
