...
<section class="content" style="text-align: center">
    ...
    <section class="content" style="text-align: center; background: #ffffff;">
        <div style="margin-bottom: 20px;">
            <a href="<?=base_url('website/Uet_content_mid/Add_News_hot');?>" class="btn btn-primary pull-left" style="border-radius: 0px;">Thêm tin tức nổi bật</a>
        </div>
                        ...
                        <?php if(isset($danhmuc_sanpham) && !empty($danhmuc_sanpham)){ $i = 0; foreach ($danhmuc_sanpham as $spdm) {
                            ...
                            $i++; ?>
                                <tr>
                                    ...
                                    <td><?= $spdm->number ?></td>
                                    <td>
                                        <a href="<?=base_url('website/Uet_content_mid/')."edit_News_hot/$spdm->id"?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Sửa</a>
                                        <a href="<?=base_url('website/Uet_content_mid/')."Delete_News_hot/$spdm->id"?>" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i> Xóa</a>
                                    </td>
                                </tr>
                            <?php }
                        }?>
