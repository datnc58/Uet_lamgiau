...
<!--            <a href="--><?//=base_url('website/Uet_content_mid/Add_Product_hot')."/$id_mid";?><!--" class="btn btn-primary pull-left" style="border-radius: 0px;">Thêm sản phẩm nổi bật</a>-->
        </div>
                        ...
                        <?php if(isset($danhmuc_sanpham) && !empty($danhmuc_sanpham)){ foreach ($danhmuc_sanpham as $spdm) {
                            ...
                            $i++; ?>
                                <tr>
                                    ...
                                    <td><?= $spdm->number ?></td>
                                    <td>
                                        <a href="<?=base_url('website/Uet_content_mid/')."edit_Product_hot/$spdm->id/$id_mid"?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Sửa</a>
                                        <a href="<?=base_url('website/Uet_content_mid/')."Delete_Product_hot/$spdm->id/$id_mid"?>" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i> Xóa</a>
                                    </td>
                                </tr>
                            <?php }
                        }?>
