...
<!--        <li><a href="">Bước 3: chọn footer</a></li>-->
<!--        <li><a href="">Bước 4: chọn content - top</a></li>-->
<!--        <li><a href="">Bước 5: chọn content - bottom</a></li>-->
    </ul>
</section>
<!-- Main content -->
<div class="col-md-12">
    <section class="content" style="text-align: center; background: #ffffff; width: 100%; display: inline-block; padding: 30px 0px;">
        <div class="col-md-12">
            <a href="<?=base_url('website/Uet_createwebsite/header/').$id_web?>">
                <div class="mid" style="text-align: center">
                    <img src="<?=base_url('assets/library/header_container.png');?>" style="width: 80%; margin: 0 auto;" alt=""/>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-12" style="margin-top: 50px;">
            <a href="<?=base_url('website/Uet_createwebsite/header/').$id_web?>">
                <div class="mid" style="text-align: center">
                    <img src="<?=base_url('assets/library/header_full.png');?>" style="width: 80%; margin: 0 auto;" alt=""/>
                </div>
            </a>
        </div>
    </section>
